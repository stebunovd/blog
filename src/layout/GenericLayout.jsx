  ...
  return (
    <>
      <a
        ...
        href="https://github.com/stebunovd/blog"
      >
        <svg
          width="80"
          height="80"
        ...
        >
          ...
          <path
            d={
              'M128.3,109.0 C113.8,99.7 119.0,89.6 119.0,89.6 C122.0,82.7 120.5,78.6 120.5,78.6'
          ...
          <path
            d={
              'M115.0,115.0 C114.9,115.1 118.7,116.5 119.8,115.4 L133.7,101.6 C136.9,99.2'
